<template>
    <div class="fillcontain">
        ...
        <div class="table_container">
                ...
                <el-table-column type="expand">
                  <template scope="props">
                    <el-form label-position="left" inline class="demo-table-expand">
                      ...
                      <el-form-item label="会员卡 ID">
                        <span>{{ props.row.item_id }}</span>
                      </el-form-item>
                      <el-form-item label="商户 ID">
                        <span>{{ props.row.restaurant_id }}</span>
                      </el-form-item>
                      <el-form-item label="会员卡介绍">
                        <span>{{ props.row.description }}</span>
                      </el-form-item>
                      <el-form-item label="商户地址">
                        <span>{{ props.row.restaurant_address }}</span>
                      </el-form-item>
                      <el-form-item label="会员卡评分">
            ...
            <el-dialog title="修改会员卡信息" v-model="dialogFormVisible">
                <el-form :model="selectTable">
                    <el-form-item label="会员卡名称" label-width="100px">
                        <el-input v-model="selectTable.name" auto-complete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="会员卡介绍" label-width="100px">
                        <el-input v-model="selectTable.description"></el-input>
                    </el-form-item>
                    <el-form-item label="会员卡分类" label-width="100px">
                    ...
                    <el-form-item label="会员卡图片" label-width="100px">
                        <el-upload
